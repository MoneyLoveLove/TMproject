...
<%
	...
	String tName ="";
	switch(tCode){
		case "ADM" : tName = "관리팀"; break;
		case "DES" : tName = "디자인팀"; break;
		case "DEV" : tName = "개발팀"; break;
		case "FIN" : tName = "재무팀"; break;
		case "MAN" : tName = "경영팀"; break;
		case "SAL" : tName = "영엽팀"; break;
	}
	String pCode= dto.getpCode();
	String pName="";
	switch(pCode){
		case "AD" : pName = "관리자"; break;
		case "CH" : pName = "팀장"; break;
		case "PR" : pName = "사장"; break;
		case "ST" : pName = "사원"; break; 
